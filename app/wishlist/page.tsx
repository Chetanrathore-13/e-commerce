              ...
              {wishlistItems.length === 0 ? (
                ...
                <div className="space-y-8">
                  {wishlistItems.map((item) => {
                    ...
                    return (
                      <div key={item._id} className="flex flex-col md:flex-row gap-6 border-b pb-8">
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            <div className="flex justify-between">
                              <Link
                                href={`/products/${item.product.slug}`}
                                className="text-lg font-medium hover:text-amber-700"
                              >
                                {item.product.name}
                              </Link>
                              <button
                            ...
                            <p className="mt-2 font-medium text-lg">{formattedPrice}</p>
                          </div>
                          <div className="mt-4 md:mt-0">
                            <Button
                              className="w-full md:w-auto border border-amber-700 text-amber-700 hover:bg-amber-700 hover:text-white bg-transparent"
                              onClick={() => addToCart(item.product._id, item.variation._id)}
                            >
                              Add To Cart
                            </Button>
                          </div>
