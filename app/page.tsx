...
import { getHomepageSectionsData, getTestimonialsData, getCategoriesData, getProductsData } from "@/lib/api"
...
export default async function Home() {
  ...
  const [sectionsData, testimonialsData, categoriesData, newArrivalsData, bestSellersData] = await Promise.allSettled([
  ...
  return (
    <main>
      ...
      <FeaturedCategories
        ...
        sectionSubtitle={featuredCategoriesSection?.subtitle || "Explore our diverse collection of ethnic wear"}
      />
      ...
      <NewArrivals
        ...
        sectionSubtitle={newArrivalsSection?.subtitle || "Check out our latest products"}
      />
      ...
      <BestSellers
        ...
        sectionSubtitle={bestSellersSection?.subtitle || "Our most popular products"}
      />

      {/* Featured Collections */}
      <FeaturedCollections
        sectionImage={featuredCollectionsSection?.image}
        sectionTitle={featuredCollectionsSection?.title || "Featured Collections"}
        sectionSubtitle={featuredCollectionsSection?.subtitle || "Explore our curated collections"}
      />
      ...
      <Testimonials
        ...
        sectionSubtitle={testimonialsSection?.subtitle || "Read testimonials from our satisfied customers"}
      />
      ...
      <InstagramFeed
        ...
        sectionSubtitle={instagramFeedSection?.subtitle || "Get inspired by our latest posts"}
      />
    </main>
  )
}
