...
async function getBlogs() {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/blogs?limit=6`, {
      cache: "no-store",
    })
    ...
    return { blogs: [], pagination: { total: 0, page: 1, limit: 6, totalPages: 0 } }
  }
}
    ...
    <div className="bg-neutral-50 min-h-screen py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-light mb-4">Our Blog</h1>
