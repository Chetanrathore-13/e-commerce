...
export function CategoryForm({ category, parentCategories }: CategoryFormProps) {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      name: category?.name || "",
      parent_category_id: category?.parent_category_id ? category.parent_category_id.toString() : "",
      image: undefined,
    },
  })
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    ...
                    {parentCategories.map((parentCategory) => (
                      <SelectItem key={parentCategory._id.toString()} value={parentCategory._id.toString()}>
                        {parentCategory.name}
                      </SelectItem>
                    ))}
                  </SelectContent>
