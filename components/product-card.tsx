...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  const [isInWishlists, setIsInWishlist] = useState(false);
  ...
  const toggleWishlist = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      const added = await toggleWishlistItem(product._id, variation._id);
      ...
      toast({
        title: "Error",
        description: "Wishlist action failed",
        variant: "destructive",
      });
    } finally {
      ...
      <div className="aspect-[3/4] w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75">
        ...
        >
          <Heart
            ...
            fill={
              isInWishlist(product._id, variation._id) ? "currentColor" : "none"
            }
          />
