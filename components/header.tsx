...
import LoginPopUp from "@/components/loginComp"
...
export default function Header() {
        ...
        const handleOpenLoginPopup = () => {
                console.log("Open login popup",status);
                                                        ...
                                                        <SheetContent side="left" className="w-[300px] overflow-y-auto">
                                                                <div className="flex flex-col h-full">
                                                                        ...
                                                                        <nav className="flex flex-col py-4">
                                                                                                        ...
                                                                                                        <div key={category._id} className="collapsible">
                                                                                                                <Link
                                                                                                                        href={`/${category.name
                                                                                                                                .toLowerCase()
                                                                                                                                .replace(/\s+/g, "-")}`}
                                                                                                                        className={`px-2 py-3 flex justify-between items-center ${isActive(
                                                                                                                                `/${category.name
                                                                                                                                        .toLowerCase()
                                                                                                                                        .replace(/\s+/g, "-")}`
                                                                                                                        )
                                                                                                                                                ...
                                                                                                                                                <Link
                                                                                                                                                        ...
                                                                                                                                                        href={`/${category.name
                                                                                                                                                                ...
                                                                                                                                                                .replace(
                                                                                                                                                                        ...
                                                                                                                                                                        .toLowerCase()
                                                                                                                                                                        .replace(/\s+/g, "-")}`}
                                                                                                                                                        className={`px-2 py-2 block ${isActive(
                                                                                                                                                                `/${category.name
                                                                                                                                                                        .toLowerCase()
                                                                                                                                                                        .replace(
                                                                                                                                                                                /\s+/g,
                                                                                ...
                                                                                <Link
                                                                                        href="/bridal"
                                                                                        className={`px-2 py-3 ${isActive("/bridal")
                                                                                                        ? "text-teal-800 font-medium"
                                                                                                        : "text-gray-700"
                                                                                                } hover:text-teal-800 border-b`}
                                                                                >
                                                                                ...
                                                                                <Link
                                                                                        href="/collections"
                                                                                        className={`px-2 py-3 ${isActive("/collections")
                                                                                                        ? "text-teal-800 font-medium"
                                                                                                        : "text-gray-700"
                                                                                                } hover:text-teal-800 border-b`}
                                                                                >
                                                                                ...
                                                                                <Link
                                                                                        href="/contact"
                                                                                        className={`px-2 py-3 ${isActive("/contact")
                                                                                                        ? "text-teal-800 font-medium"
                                                                                                        : "text-gray-700"
                                                                                                } hover:text-teal-800 border-b`}
                                                                                >
                                                ...
                                                <div className="   overflow-x-auto relative">
                                                        <div className="container mx-auto px-4 relative">
                                                                <nav className="flex items-center space-x-8 py-3 whitespace-nowrap">
                                                                                ...
                                                                                categories.map((category) => (
                                                                                        <Link
                                                                                                ...
                                                                                                href={`/${category.name
                                                                                                        .toLowerCase()
                                                                                                        .replace(/\s+/g, "-")}`}
                                                                                                className={`text-sm hover:text-teal-800 ${isActive(
                                                                                                        `/${category.name
                                                                                                                .toLowerCase()
                                                                                                                .replace(/\s+/g, "-")}`
                                                                                                )
                                                                        ...
                                                                        <Link
                                                                                href="/collections"
                                                                                className={`text-sm hover:text-teal-800 ${isActive("/collections")
                                                                                                ? "text-teal-800 font-medium"
                                                                                                : ""
                                                                                        }`}
